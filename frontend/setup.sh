...
appservices secrets create --app="$APP_ID" --project="$ATLAS_PROJECT_ID" --name="azure-openai-key" --value="$AZURE_OPENAI_API_KEY"
appservices secrets create --app="$APP_ID" --project="$ATLAS_PROJECT_ID" --name="azure-endpoint" --value="$AZURE_OPENAI_ENDPOINT" 
